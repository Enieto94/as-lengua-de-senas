<template>
  <MenuAtrasTop></MenuAtrasTop>
    <main>
        <h1>QUIZ VERBOS ASL </h1>
        <div v-if="!repaso">
            <h2>REPASO</h2>
            <center>
                <video  src="https://apiasl.netlify.app/src/img/repaso/verbos.mp4" autoplay="true"  muted></video>
            </center>
        ...
        <div v-if="repaso">
            <section class="quiz" v-if="!quizCompleted">
                <center>
                    <progress id="file" max="100" :value="score*9" >  </progress>
                </center>
                <div class="quiz-info">
...
import MenuAtrasTop from "../components/MenuAtrasTop.vue";
  ...
  const questions = ref([
        {
            question: "https://apiasl.netlify.app/src/img/verbos/Bailar.gif",
            answer: 2,
            options: [
                'Nadar',
                'Dormir',
        ...
        {
            question: "https://apiasl.netlify.app/src/img/verbos/Beber.gif",
            answer: 0,
            options: [
                'Beber',
                'Nadar',
        ...
        {
            question: "https://apiasl.netlify.app/src/img/verbos/Caminar.gif",
            answer: 0,
            options: [
                'Caminar',
                'Correr',
        ...
        {
            question: "https://apiasl.netlify.app/src/img/verbos/comer.gif",
            answer: 0,
            options: [
                'Comer',
                'Correr',
        ...
        {
            question: "https://apiasl.netlify.app/src/img/verbos/Correr.gif",
            answer: 2,
            options: [
                'Caminar',
                'Dormir',
        ...
        {
            question: "https://apiasl.netlify.app/src/img/verbos/Dormir.gif",
            answer: 1,
            options: [
                'Escribir',
                'Dormir',
        ...
        {
            question: "https://apiasl.netlify.app/src/img/verbos/Escribir.gif",
            answer: 3,
            options: [
                'Reir',
                'Llorar',
        ...
        {
            question: "https://apiasl.netlify.app/src/img/verbos/Leer.gif",
            answer: 1,
            options: [
                'Caminar',
                'Leer',
        ...
        {
            question: "https://apiasl.netlify.app/src/img/verbos/Nadar.gif",
            answer: 3,
            options: [
                'Llorar',
                'Reir',
