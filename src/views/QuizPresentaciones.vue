...
import MenuAtrasTop from "../components/MenuAtrasTop.vue";
  ...
  const questions = ref([
        {
            question: "https://apiasl.netlify.app/src/img/presentacion/hola.gif",
            answer: 2,
            options: [
                'Mi nombre es:',
                'Disculpas',
        ...
        {
            question: "https://apiasl.netlify.app/src/img/presentacion/me-llamo.gif",
            answer: 0,
            options: [
                'Me llamo: ',
                'No, está equivocado',
        ...
        {
            question: "https://apiasl.netlify.app/src/img/presentacion/mi-sena-es.gif",
            answer: 0,
            options: [
                'Mi seña es',
                'Me llamo:',
        ...
        {
            question: "https://apiasl.netlify.app/src/img/presentacion/nombre.gif",
            answer: 0,
            options: [
                'Nombre',
                'Tengo 18',
        ...
        {
            question: "https://apiasl.netlify.app/src/img/presentacion/tengo-18.gif",
            answer: 0,
            options: [
                'Tengo 18',
                'Hola',
